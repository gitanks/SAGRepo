      ...
      <TD>
          ...
          <TR class="fullinputwidth">
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              %ifvar funct equals(Add)%
                <INPUT NAME="driver" TYPE="TEXT" VALUE="">
              %else%
          ...
          <TR class="fullinputwidth">
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              %ifvar funct equals(Display)%
               ...
               %else%
                <INPUT NAME="description" TYPE="TEXT" VALUE="%value driver.description encode(htmlattr)%">
              %endif%
            </TD>
          </TR>
          <SCRIPT>swapRows();</SCRIPT>
          <TR class="fullinputwidth">
            ...
            <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
              ...
              %else%
                <INPUT NAME="classname" TYPE="TEXT" VALUE="%value driver.class encode(htmlattr)%">
              %endif%
            </TD>
          </TR>
          <SCRIPT>swapRows();</SCRIPT>
