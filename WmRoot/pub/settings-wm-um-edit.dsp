...
<body onLoad="loadDocument();loadKeyStoresOptions();">
  ...
  <TABLE width="100%">
    ...
    <TR>
      <TD colspan="2">
        <ul class="listitems">
          <li class="listitem"><a href="settings-wm-um-detail.dsp?aliasName=%value aliasName encode(url)%">Return to Universal Messaging Connection Alias</a></li>
        </UL>
      </TD>
    </TR>
    <TR>
	  ...
	  <table class="tableView" width="85%">	  
          ...
          <TR>
            ...
            <TD class="evenrowdata-l"><INPUT NAME="um_tryAgainMaxAttempts" size="50" value="%value um_tryAgainMaxAttempts encode(htmlattr)%"></TD>
          </TR>
	  ...
	  <table class="tableView" width="85%">
          ...
          <TR>
            ...
            <TD class="evenrowdata-l"><INPUT NAME="csqSize" size="50" value="%value csqSize encode(htmlattr)%"></TD>
          </TR>
          ...
          <TR>
            ...
            <TD class="evenrow-l"><INPUT NAME="um_publishWaitTime" size="50" value="%value um_publishWaitTime encode(htmlattr)%"></TD>
          </TR>
	  ...
	  <table class="tableView" width="85%">
          ...
          <TR>
            <TD width="40%" class="oddrow-l">Client Authentication</TD>
            <TD class="oddrowdata-l">
		...
		<TD colspan=2 style="margin: 0px; padding: 0px; border-spacing: 0px;">
			    <TABLE width="100%">
					<TR>
				<TD  width="40%"  class="evenrow-l">Truststore Alias</TD>
				<TD class="evenrowdata-l">
