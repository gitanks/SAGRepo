      ...
      <td>
        ...
        <table class="tableView" width="100%">
          ...
          %ifvar associationType equals('0')%
            <tr>
              <td class="evenrow-l" width="40%">Create Connection Using</td>
            ...
            %ifvar jndi_connectionFactoryUpdateType equals('CLIENT_POLL')%
              <tr>
                <td class="evenrow-l" width="40%">Polling Interval</td>
        ...
        <table class="tableView" width="100%">
          ...
          <!-- Class Loader -->
          <tr>
            <td class="row-l" width="40%">Class Loader</td>
            <td class="rowdata-l">%value classLoader encode(html)%</td>
          </tr>
        ...
        <table class="tableView" width="100%">
          ...
          %ifvar producerCachingMode -notempty%
              ...
              %case '1'%
                      ...
                      <tr>
                          <td class="row-l" width="40%">Minimum Pool Size</td>
                          <script>writeTD("rowdata-l");</script>%value producerSessionPoolMinSize encode(html)%</td>
                      </tr>
                     
                      <tr>
                          <td class="row-l" width="40%">Maximum Pool Size</td>
                  ...
                  %case '2'%
                      ...
                      %else%
                          <!-- Using JNDI -->
                      <tr>
                              <td class="row-l" width="40%">Destination Lookup Name List (semicolon delimited)</td>
